...
export const products: Product[] = [
  // PLYWOOD CATEGORY
  {
    ...
    description: 'Built for high-load and long-life applications with exceptional strength and durability.',
    thicknesses: ['19MM', '16MM', '12MM', '09MM', '06MM'],
    specifications: [
      'IS: 1000 SERIES',
      'FRIE RETARDANT',
      'LIFE TIME GUARANTEE',
  ...
  },
  {
    ...
    description: 'Fire-resistant and robust — for projects requiring safety and surface precision.',
    thicknesses: ['19MM', '16MM', '12MM', '09MM', '06MM'],
    specifications: [
      'FRIE RETARDANT',
      'CALIBRATED SURFACE',
  ...
  },
  {
    ...
    category: 'Plywood',
    subcategory: 'Marine',
    description: 'Marine-grade performance with exceptional bonding and stability for wet areas.',
    thicknesses: ['19MM', '16MM', '12MM', '09MM', '06MM'],
    specifications: [
      'LIFE TIME GUARANTEE',
      'GURJAN FACE 100%',
  ...
  },
  {
    ...
    category: 'Plywood',
    subcategory: 'Premium',
    description: 'Premium plywood for high-end interiors and exposed surfaces with 30-year warranty.',
    thicknesses: ['19MM', '16MM', '12MM', '09MM', '06MM'],
    specifications: [
      '30 YEARS WARRANTY',
  ...
  },
  {
    ...
    description: 'Engineered for resilience — impact and environment resistant with 20-year warranty.',
    thicknesses: ['19MM', '16MM', '12MM', '09MM', '06MM'],
    specifications: [
      '20 YEARS WARRANTY',
      'ISI: 710 BWP MARINE GRADE',
  ...
  },
  {
    ...
    description: 'Bright, consistent and precisely finished plywood for visible interiors with IS: 303 grade.',
    thicknesses: ['19MM', '16MM', '12MM', '09MM', '06MM'],
    specifications: [
      '10 YEARS WARRANTY',
      'IS: 303 GRADE',
  ...
  // DOORS CATEGORY
  {
    ...
    tagline: 'Stable Core',
    category: 'Doors',
    subcategory: 'Core Panels',
    description: 'Stable core panels for doors, partitions and furniture frames with BWR grade.',
  ...
  },
  {
    ...
    description: 'Engineered flush doors with high-density cores and consistent performance for residential and commercial applications.',
