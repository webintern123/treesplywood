      ...
      {[
        ...
        >
          ...
          >
            {/* Icon */}
            <div
              className={`w-14 h-14 rounded-full bg-gradient-to-br ${benefit.color} flex items-center justify-center mx-auto mb-4`}
            >
              <benefit.icon className="w-7 h-7 text-white" />
            </div>

            {/* Card Title — H3 (20px) */}
            <h3 className="text-xl font-semibold text-trees-secondary mb-2">
              {benefit.title}
            </h3>
...
>
    ...
    return (
      <MagneticButton key={productId} strength={0.2}>
        <ModernButton
          variant="primary"
          size="lg"
          className="w-full h-28 px-4 text-sm font-medium flex items-center justify-center text-center"
          onClick={() => {
            if (onProductSelect) {
  ...
  <ModernSectionHeader
    ...
    title="How This Tool Helps You Choose Better" // H2 – 24px, semibold
    subtitle="Real numbers from thousands of builders, designers, and homeowners who used this tool to make smarter decisions." // Body – 16px
  />
      ...
      >
        <ModernCard variant="elevated" className="p-6 h-full group hover:shadow-2xl transition-all duration-300">
          ...
          <div className="mb-2">
            ...
            <div className="font-semibold text-[14px] text-gray-700 mb-2">
              {stat.label}
            </div>
    ...
    <ModernCard variant="outlined" className="p-8 max-w-3xl mx-auto">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 text-left">
          <h4 className="text-[24px] font-semibold text-trees-secondary mb-2">Why it Matters</h4>
          <p className="text-[16px] text-gray-600 leading-relaxed">
            Our comparison tool has helped over <strong>10,000 users</strong> choose the right plywood for their project.  
  ...
  <div className="grid md:grid-cols-4 gap-6 mt-6">
    {[
      ...
      <motion.div
        ...
        transition={{ delay: idx * 0.1 }}
      >
        <ModernCard variant="outlined" className="p-6 text-center h-full relative group hover:shadow-lg transition-shadow">
          ...
          <div className="w-12 h-12 rounded-lg bg-trees-primary/10 flex items-center justify-center mx-auto mb-4 mt-2 group-hover:scale-110 transition-transform duration-300">
      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-trees-secondary text-[20px] font-semibold mb-2 group-hover:text-trees-primary transition-colors">
              Plywood Calculator
            </h3>
            <p className="text-[16px] text-gray-600 mb-4">
              Work out how many sheets you need with quick and accurate measurements.
            </p>
            <div className="flex items-center gap-2 text-trees-primary font-medium text-sm group-hover:gap-3 transition-all">
  ...
  <div className="max-w-3xl mx-auto text-center relative">
    ...
    >
      <input
        ...
        className="flex-1 px-6 py-3 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-white/50 text-[16px]"
      />
      <MagneticButton strength={0.2}>
        <ModernButton
          variant="outline"
          size="lg"
          className="bg-white text-trees-primary border-white hover:bg-gray-50 text-[16px]"
...
<section className="section-padding text-center">
  ...
  <h2 className="text-trees-secondary text-[24px] font-semibold mb-4">
    Found the Right Product?
  </h2>
  <p className="text-gray-600 text-[16px] mb-8 max-w-2xl mx-auto leading-relaxed">
