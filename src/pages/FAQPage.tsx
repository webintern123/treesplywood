        ...
        >
          <ModernCard variant="elevated" className="p-6 h-full relative">
            ...
            <div className="absolute -top-3 -right-3 w-10 h-10 rounded-full bg-gradient-to-br from-trees-primary to-trees-secondary flex items-center justify-center shadow-lg">
              <span className="text-white font-bold text-[14px]">{step.step}</span>
            </div>
            ...
            <h4 className="text-trees-secondary text-[20px] font-semibold mb-2">{step.title}</h4>
      ...
      {[
        ...
        >
          <ModernCard variant="elevated" className="p-6 h-full text-center">
            ...
            <div
              className={`w-16 h-16 rounded-xl bg-gradient-to-br ${benefit.color} flex items-center justify-center mx-auto mb-4`}
            >
              <benefit.icon className="w-8 h-8 text-white" />
            </div>

          
            <h4 className="text-trees-secondary text-[20px] font-semibold mb-2">{benefit.title}</h4>
      ...
      {[
        ...
        >
          <ModernCard variant="elevated" className="p-6 h-full text-center">
            ...
            <div className="text-2xl md:text-3xl font-bold text-trees-primary mb-2">{stat.value}</div>

           
            <h4 className="text-trees-secondary text-[20px] font-semibold mb-1">{stat.label}</h4>

           
            <p className="text-gray-600 text-[14px]">{stat.desc}</p>
          </ModernCard>
        </motion.div>
      ))}
    </div>
        ...
        >
          <ModernCard variant="elevated" className="p-6 h-full">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-trees-primary to-trees-secondary/80 flex items-center justify-center flex-shrink-0">
                <HelpCircle className="w-6 h-6 text-white" />
              </div>
              <div className="flex-1 min-w-0">
                <h4 className="text-trees-secondary text-[20px] font-semibold mb-2 line-clamp-2">
                  {faq.question}
                </h4>
  ...
  <div className="container mx-auto px-6">
    ...
    <div className="max-w-2xl mx-auto mb-12">
      <div className="relative">
        ...
        <Input
          ...
          className="pl-12 h-14 text-base glass-card border-trees-primary/20 focus:border-trees-primary"
        />
        {searchQuery && (
      ...
      {categories.map((cat) => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-2 px-5 py-3 rounded-full transition-all text-sm font-medium ${
              isActive
          ...
          >
            ...
            <span>{cat.name}</span>
            {!isActive && <Badge variant="secondary">{count}</Badge>}
          </button>
        );
      })}
    </div>
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <h3 className="text-trees-secondary text-[20px] font-semibold">All Questions</h3>
      ...
      {filteredFaqs.length === 0 ? (
        <ModernCard variant="elevated" className="p-12 text-center">
          ...
          <h4 className="text-gray-700 text-[16px] font-semibold mb-2">No questions found</h4>
          <p className="text-sm text-gray-600 mb-6">Try adjusting your search or category filter</p>
          <ModernButton
            variant="outline"
            size="md"
            onClick={() => {
              ...
              >
                <AccordionTrigger className="text-left hover:no-underline py-5 group">
                  <div className="flex items-start gap-3 pr-4 flex-1">
                    ...
                    <span className="text-gray-800 group-data-[state=open]:text-trees-primary transition-colors text-base font-medium">
                      {faq.question}
                    </span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="pt-2 pb-5">
                  <div className="text-sm text-gray-600 leading-relaxed [&_*]:text-sm [&_*]:text-gray-600 [&_*]:leading-relaxed">
                    {faq.answer}
                  </div>
                </AccordionContent>
              </AccordionItem>
    ...
    <div className="grid md:grid-cols-3 gap-6 mt-8">
      {[
        ...
        },
        {
          ...
          color: 'from-purple-500 to-purple-600',
          onClick: () => {
            const phone = '918712415760'; // ✅ country code + number only
...
Requirement:
        ...
        >
          <ModernCard variant="elevated" className="p-8 h-full text-center">
            ...
            <h4 className="text-trees-secondary mb-2 text-[20px] font-semibold">{channel.title}</h4>
            <p className="text-sm text-gray-600 mb-2">{channel.desc}</p>
            <p className="text-trees-primary mb-6 text-sm font-medium">{channel.info}</p>
      ...
      {[
        ...
        >
          ...
          >
            ...
            <h4 className="text-base md:text-[16px] font-semibold text-trees-secondary mb-2 group-hover:text-trees-primary transition-colors">
              {resource.title}
            </h4>
            <p className="text-base md:text-[16px] text-gray-600 mb-4">{resource.desc}</p>

            <div className="flex items-center text-trees-primary text-sm md:text-[14px] font-medium group-hover:translate-x-1 transition-transform">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
      {[
        ...
        },
        {
          ...
          desc: 'Most common doubts are answered right at the top, it saves time.',
          color: 'from-purple-500 to-purple-600'
        },
        {
          icon: Download,
  ...
  <div className="container mx-auto px-6 relative z-10 text-center">
    ...
    >
      <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/20 backdrop-blur-sm text-white font-medium mb-8 text-sm">
      ...
      <div className="flex flex-wrap gap-4 justify-center mb-12">
        <MagneticButton strength={0.2}>
          <ModernButton
            ...
            className="text-[14-16px] font-medium"
          >
            Contact Support
          </ModernButton>
        </MagneticButton>
        ...
        <MagneticButton strength={0.2}>
          <ModernButton
            ...
            className="border-white text-white hover:bg-white/20 text-[14-16px] font-medium"
          >
            Request Samples
          </ModernButton>
        </MagneticButton>
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-12 pt-8 border-t border-white/20">
        {[
          { icon: Phone, label: 'Sales', value: '+91 9091744744' },
          { icon: Mail, label: 'Support', value: 'support@thetreesplywood.com' },
          { icon: Award, label: 'Warranty', value: 'warranty@thetreesplywood.com' },
        ].map((contact, idx) => (
          <div key={idx} className="text-white/90">
            <div className="flex items-center justify-center gap-2 mb-2">
              <contact.icon className="w-5 h-5" />
              <p className="font-semibold text-[14px] text-white/80">{contact.label}</p>
            </div>
            <p className="text-[12px] text-white/80">{contact.value}</p>
          </div>
        ))}
      </div>
    </motion.div>
