...
const filteredProducts =
  ...
  <div className="bg-gray-50 border-b border-gray-200">
    <div className="container mx-auto px-6 py-3 text-[14px] font-normal">
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink
          ...
          <BreadcrumbItem>
            <BreadcrumbPage className="text-trees-primary font-semibold text-[14px]">
              Products
            </BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
          ...
          {categories.map((category) => (
            <button
              ...
              onClick={() => {
                ...
                if (category !== 'Plywood') setSelectedSubcategory('All Plywood');
              }}
    ...
    <div className="container mx-auto px-6">
      {filteredProducts.length === 0 ? (
        <div className="text-center py-20">
          ...
          <h3 className="text-[20px] font-semibold text-gray-900 mb-2">No Products Found</h3>
          <p className="text-[14px] font-normal text-gray-600">Try adjusting your filters</p>
        </div>
      ) : (
                ...
                <div className="relative h-56 rounded-t-2xl overflow-hidden group">
                  ...
                  {product.badge && (
                    <div className="absolute top-4 right-4">
                      <span className="px-4 py-1.5 rounded-full bg-trees-primary text-white text-[12px] font-semibold shadow-lg flex items-center gap-1.5">
  ...
  <h3 className="text-[20px] font-semibold text-white">
    {product.name}
                ...
                <div className="p-5 space-y-3">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-trees-primary/10 text-trees-primary text-[14px] font-medium">
                  ...
                  <div className="space-y-2">
                    {product.keyFeatures.slice(0, 3).map((feature, i) => (
                      <div key={i} className="flex items-start gap-2">
                        ...
                        <span className="text-[14px] font-normal text-gray-600">{feature}</span>
                      </div>
                    ))}
                  </div>

                  <div>
                    <p className="text-[12px] font-normal text-gray-500 mb-2">
                      Available Thickness:
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {product.thicknesses.slice(0, 5).map((thickness) => (
                        <span
                          key={thickness}
                          className="px-3 py-1 rounded-lg bg-gray-100 text-gray-800 text-[12px] font-medium"
                        >
                          {thickness}
                        </span>
                      ))}
      ...
      {/* Results Count */}
      <div className="text-center mt-12 text-[14px] font-normal text-gray-600">
        Showing <span className="font-semibold text-trees-primary">{filteredProducts.length}</span> products
      </div>
    </div>
  </section>
  ...
  <div className="container mx-auto px-6">
    ...
    >
      ...
      <h3 className="mb-4 text-[20px] font-semibold text-gray-900">
        Not Sure Which Product to Pick?
      </h3>

     
      <p className="text-[16px] font-normal text-gray-600 mb-8">
    ...
    <div className="grid md:grid-cols-4 gap-6 mt-8">
      {[
        ...
        <motion.div
          ...
          transition={{ delay: idx * 0.1 }}
        >
          <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200 text-center hover:shadow-lg transition-all duration-300 h-full">
            ...
            <h4 className="text-[20px] font-semibold text-gray-900 mb-2">
              {cert.name}
            </h4>
...
<section className="section-padding bg-gray-50">
        ...
        >
          <ModernCard variant="elevated">
            <div className="p-6 text-center space-y-4">
              ...
              <div className="pt-2">
                <p className="text-[14px] font-medium text-trees-primary">
                  {app.products}
                </p>
              </div>
            </div>
    ...
    <div className="bg-gradient-to-br from-trees-primary to-trees-secondary rounded-3xl p-12 text-white text-center overflow-hidden relative">
      ...
      >
        ...
        <h3 className="text-[20px] font-semibold text-white mb-4">
          Product Catalog & Guides, Ready to Download
        </h3>

       
        <p className="text-[16px] font-normal text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <ModernButton
            ...
            className="border-white text-white hover:bg-white/20 text-[14px] font-medium"
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-trees-primary/10 text-trees-primary mb-6">
            ...
            <span className="font-medium text-[14px]">Order Free Samples</span>
          </div>
          ...
          <p className="text-[16px] font-normal text-gray-700 mb-6 leading-relaxed">
          ...
          <div className="space-y-3 mb-8">
            {[
              ...
              <div key={idx} className="flex items-center gap-3">
                ...
                <span className="text-[16px] font-normal text-gray-700">{item}</span>
              </div>
            ))}
          </div>
  ...
  {warranty.years === 'Lifetime' ? 'Guarantee' : 'Year Warranty'}
              ...
              {/* Products */}
              <p className="text-[16px] font-normal text-white/90 mb-1">{warranty.products}</p>

              {/* Description */}
              <p className="text-[14px] font-normal text-white/80">{warranty.desc}</p>
            </div>
          </div>
        </motion.div>
      ))}
  ...
  <div className="container mx-auto px-6">
    ...
    >
      <div className="bg-gradient-to-br from-trees-primary/10 to-trees-secondary/10 rounded-3xl p-12 text-center border border-trees-primary/20">
        ...
        {/* Heading */}
        <h3 className="text-[20px] font-semibold mb-4 text-gray-900">
          Find Tree’s Plywood Store Dealer Near You
        </h3>

        {/* Description */}
        <p className="text-[16px] font-normal text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
...
Delivery charges vary with distance and order size. Bulk orders may get free delivery in some areas.
  ...
  <div className="container mx-auto px-6 relative z-10 text-center">
    ...
    >
      ...
      {/* Body text */}
      <p className="text-[16px] font-normal text-white/90 mb-10 leading-relaxed">
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        ...
        <ModernButton
          variant="outline"
          size="xl"
          className="text-[16px] font-medium border-white text-white hover:bg-white/20"
